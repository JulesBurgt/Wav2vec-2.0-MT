...
y12,s12 = librosa.load(r"fn001058.wav", sr=16000)
y11,s11 = librosa.load(r"fn001109.wav", sr=16000)
y13,s13 = librosa.load(r"fn001105.wav", sr=16000)
y14,s14 = librosa.load(r"fn001097.wav", sr=16000)
y15,s15 = librosa.load(r"fn001190.wav", sr=16000)
y16,s16 = librosa.load(r"fn001007.wav", sr=16000)
y17,s17 = librosa.load(r"fn001137.wav", sr=16000)
y18,s18 = librosa.load(r"fn001055.wav", sr=16000)
y19,s19 = librosa.load(r"fn001015.wav", sr=16000)
y20,s20 = librosa.load(r"fn001068.wav", sr=16000)
...
audio = np.append(audio, y11)
audio = np.append(audio, y12)
audio = np.append(audio, y13)
audio = np.append(audio, y14)
audio = np.append(audio, y15)
audio = np.append(audio, y16)
audio = np.append(audio, y17)
audio = np.append(audio, y18)
audio = np.append(audio, y19)
audio = np.append(audio, y20)
print(len(audio))
...
split_val = int(0.5 * len(logits_spikes)) #NON-RANDOM SPLIT
#print(split_val)
...
#RANDOM SPLIT
hiddenstates0_train, hiddenstates0_test = train_test_split(hidden_spikes0, test_size=0.5)
hiddenstates6_train, hiddenstates6_test = train_test_split(hidden_spikes6, test_size=0.5)
hiddenstates12_train, hiddenstates12_test = train_test_split(hidden_spikes12, test_size=0.5)
hiddenstates18_train, hiddenstates18_test = train_test_split(hidden_spikes18, test_size=0.5)
hiddenstates24_train, hiddenstates24_test = train_test_split(hidden_spikes24, test_size=0.5)
...
train_audio_labels_24 = [] #(0.5*len(logits_spikes),1)
test_audio_labels_24 = [] #(0.5*len(logits_spikes),1)
...
pred_array_18 = MLP18.predict(hidden_spikes18.tolist()) 
